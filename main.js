...
const speed = 1.5,
  ...
  keysTank = false, // modifique para ter um tanque controlado pelo teclado
  ...
  prologTanks = ["Teste"], //se não quiser nenhum tanque prolog, faça assim
...
function animate() {
  ...
  for (let i = 0; i < tanks.length; i++) {
    ...
    else tanks[i].draw(ctx, showSensors);
  }
  for (let i = 0; i < allBOOMS.length; i++) {
